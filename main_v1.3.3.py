...
.pv-shell.pv-layout-260218{
  --pv-depth-overscan-x: max(24vw, 260px);
  --pv-depth-overscan-y: max(22vh, 220px);
  position: relative;
  isolation: isolate;
  width: 100%;
  max-width: 100%;
...
body.pv-page-body > .pv-shell.pv-layout-260218:not(.pv-preview-live){
  --pv-depth-overscan-x: max(36vw, 360px);
  --pv-depth-overscan-y: max(28vh, 300px);
}
...
.pv-shell.pv-layout-260218::before{
  z-index: 0;
  background:
    radial-gradient(1540px 1120px at 12% 10%, var(--pv-radial-1) 0%, transparent 62%),
    radial-gradient(1500px 1080px at 88% 14%, var(--pv-radial-2) 0%, transparent 64%),
    radial-gradient(1480px 980px at 58% 76%, var(--pv-line-1-soft) 0%, transparent 72%);
...
.pv-shell.pv-layout-260218 .pv-scroll::before{
  z-index: 0;
  background:
    radial-gradient(1520px 1100px at 16% 24%, var(--pv-blob-1) 0%, transparent 68%),
    radial-gradient(1480px 1040px at 84% 72%, var(--pv-blob-2) 0%, transparent 70%),
    radial-gradient(1480px 980px at 60% 42%, var(--pv-radial-2) 0%, transparent 76%);
...
.pv-shell.pv-layout-260218 .pv-scroll::after{
  z-index: 1;
  background:
    radial-gradient(1560px 1560px at 82% 18%, var(--pv-orb-1) 0%, transparent 76%),
    radial-gradient(1480px 1480px at 82% 18%, rgba(255,255,255,0.22) 0%, transparent 52%),
    radial-gradient(1520px 1520px at 18% 74%, var(--pv-orb-2) 0%, transparent 78%),
    radial-gradient(1680px 1680px at 80% 22%, transparent 56%, var(--pv-orb-ring) 60%, transparent 82%),
    radial-gradient(1480px 1480px at 70% 82%, var(--pv-orb-2) 0%, transparent 84%);
                        ...
                        with ui.element("div").classes("pv-hero-track"):
                            for url in hero_urls:
                                with ui.element("div").classes("pv-hero-slide"):
                                    ...
                                    ui.image(pv_img_src(url, max_w=_hero_dims[0], max_h=_hero_dims[1])).classes("pv-hero-img")
                ...
                with ui.element("section").classes("pv-section pv-section-260218").props('id="pv-about"'):
                    ...
                    with ui.element("div").classes("pv-panel pv-panel-glass"):
                        if about_image_url:
                            ...
                            ui.image(pv_img_src(about_image_url, max_w=_about_dims[0], max_h=_about_dims[1])).classes("pv-about-img q-mb-sm")
                ...
                with ui.element("section").classes("pv-section pv-section-260218").props('id="pv-services"'):
                    ...
                    with ui.element("div").classes("pv-panel pv-panel-glass"):
                        if svc_image_url:
                            ...
                            ui.image(pv_img_src(svc_image_url, max_w=_svc_dims[0], max_h=_svc_dims[1])).classes("pv-services-img q-mb-sm")
