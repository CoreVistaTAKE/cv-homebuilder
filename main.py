...
def _preview_glass_style(step1_or_primary=None, *, dark: Optional[bool] = None, **_ignore) -> str:
    ...
    def _alpha(base: float) -> float:
        scale = {"weak": 0.72, "medium": 1.00, "strong": 1.42}.get(strength, 1.00)
    ...
    if not is_dark:
        ...
        line_1 = _rgba(_blend_hex(accent, "#ffffff", 0.48), _alpha(0.110))
        line_2 = _rgba(_blend_hex(accent2, "#ffffff", 0.52), _alpha(0.092))
        line_1_soft = _rgba(_blend_hex(accent3, "#ffffff", 0.74), _alpha(0.042))
        ...
        radial_opacity = {"weak": 0.26, "medium": 0.70, "strong": 1.08}.get(strength, 0.70)
        blob_opacity = {"weak": 0.14, "medium": 0.38, "strong": 0.74}.get(strength, 0.38)
        line_opacity = {"weak": 0.10, "medium": 0.26, "strong": 0.60}.get(strength, 0.26)
        orb_opacity = {"weak": 0.22, "medium": 0.54, "strong": 0.92}.get(strength, 0.54)
        panel_show_opacity = {"weak": 0.012, "medium": 0.060, "strong": 0.150}.get(strength, 0.060)
    else:
        ...
        line_1 = _rgba(_blend_hex(accent, "#ffffff", 0.58), _alpha(0.118))
        line_2 = _rgba(_blend_hex(accent2, "#ffffff", 0.60), _alpha(0.100))
        line_1_soft = _rgba(_blend_hex(accent3, "#ffffff", 0.76), _alpha(0.046))
        ...
        radial_opacity = {"weak": 0.20, "medium": 0.58, "strong": 0.98}.get(strength, 0.58)
        blob_opacity = {"weak": 0.11, "medium": 0.30, "strong": 0.62}.get(strength, 0.30)
        line_opacity = {"weak": 0.10, "medium": 0.24, "strong": 0.58}.get(strength, 0.24)
        orb_opacity = {"weak": 0.18, "medium": 0.48, "strong": 0.84}.get(strength, 0.48)
        panel_show_opacity = {"weak": 0.010, "medium": 0.052, "strong": 0.128}.get(strength, 0.052)

    motion = {
        "weak": {
            "base_size": "124% 124%",
            "base_duration": "32s",
            "radial_from": "translate3d(-2.4%, -1.2%, 0) scale(1.00)",
            "radial_to": "translate3d(3.2%, 2.0%, 0) scale(1.08)",
            "radial_duration": "18.5s",
            "blob_from": "translate3d(-2.0%, 1.1%, 0) scale(1.00)",
            "blob_to": "translate3d(3.0%, -1.9%, 0) scale(1.10)",
            "blob_duration": "21.0s",
            "blob_blur": "24px",
            "line_from": "translate3d(0, 0, 0) scale(1.00) rotate(0deg)",
            "line_to": "translate3d(1.2%, -0.9%, 0) scale(1.05) rotate(0.22deg)",
            "line_duration": "23.5s",
            "orb_from": "translate3d(-1.4%, 0.2%, 0) scale(0.99)",
            "orb_to": "translate3d(3.8%, -1.8%, 0) scale(1.10)",
            "orb_duration": "17.0s",
            "orb_blur": "38px",
        },
        "medium": {
            ...
            "radial_to": "translate3d(4.8%, 2.8%, 0) scale(1.13)",
            "radial_duration": "13.6s",
            "blob_from": "translate3d(-3.0%, 1.5%, 0) scale(1.00)",
            "blob_to": "translate3d(4.2%, -2.6%, 0) scale(1.16)",
            "blob_duration": "16.2s",
            "blob_blur": "22px",
            "line_from": "translate3d(0, 0, 0) scale(1.01) rotate(0deg)",
            "line_to": "translate3d(1.8%, -1.4%, 0) scale(1.08) rotate(0.34deg)",
            "line_duration": "17.2s",
            "orb_from": "translate3d(-1.8%, 0.3%, 0) scale(0.98)",
            "orb_to": "translate3d(4.8%, -2.4%, 0) scale(1.14)",
            "orb_duration": "12.4s",
            "orb_blur": "42px",
        },
        "strong": {
            "base_size": "150% 150%",
            "base_duration": "15s",
            "radial_from": "translate3d(-4.8%, -2.4%, 0) scale(1.00)",
            "radial_to": "translate3d(5.8%, 3.4%, 0) scale(1.18)",
            "radial_duration": "9.8s",
            "blob_from": "translate3d(-3.8%, 1.9%, 0) scale(1.00)",
            "blob_to": "translate3d(5.4%, -3.2%, 0) scale(1.20)",
            "blob_duration": "11.4s",
            "blob_blur": "20px",
            "line_from": "translate3d(0, 0, 0) scale(1.02) rotate(0deg)",
            "line_to": "translate3d(2.4%, -1.8%, 0) scale(1.10) rotate(0.46deg)",
            "line_duration": "12.4s",
            "orb_from": "translate3d(-2.2%, 0.4%, 0) scale(0.97)",
            "orb_to": "translate3d(5.8%, -2.8%, 0) scale(1.18)",
            "orb_duration": "9.2s",
            "orb_blur": "46px",
        },
    }.get(motion_strength, {})
...
DEPTH_BG_CSS = r"""
/* ===== Depth Background Rebuild (v1.0.14) ===== */
html, body{
  width: 100%;
  max-width: 100vw;
  overflow-x: clip;
...
.pv-shell.pv-layout-260218::after{
  ...
  background:
    repeating-linear-gradient(126deg,
      transparent 0 86px,
      var(--pv-line-1) 86px 87.35px,
      transparent 87.35px 226px),
    repeating-linear-gradient(-126deg,
      transparent 0 126px,
      var(--pv-line-2) 126px 127.45px,
      transparent 127.45px 292px),
    linear-gradient(90deg,
      transparent 0 9%,
      var(--pv-line-1-soft) 15%,
      transparent 22%,
      transparent 72%,
      var(--pv-line-1-soft) 80%,
      transparent 88%),
    linear-gradient(132deg,
      transparent 0 32.4%,
      var(--pv-line-1-soft) 33.0%,
      transparent 33.7%,
      transparent 66.1%,
      var(--pv-line-2) 66.8%,
      transparent 67.5%,
    ...
    linear-gradient(-132deg,
      transparent 0 21.2%,
      var(--pv-line-1-soft) 21.8%,
      transparent 22.4%,
      transparent 77.6%,
      var(--pv-line-1-soft) 78.2%,
      transparent 78.8%,
      transparent 100%);
...
.pv-layout-260218 .pv-panel::before{
  ...
  background:
    ...
    repeating-linear-gradient(136deg,
      transparent 0 92px,
      var(--pv-line-1-soft) 92px 93.10px,
      transparent 93.10px 232px),
    linear-gradient(-136deg,
      transparent 0 45.2%,
      var(--pv-line-1-soft) 45.8%,
      transparent 46.4%,
      transparent 100%);
