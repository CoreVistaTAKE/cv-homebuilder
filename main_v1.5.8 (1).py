...
/* v1.5.5: 完成HP(public/export) の背景は軽量化前の見え方へ戻す。builder preview は現状維持 */
        ...
        with ui.element("div").classes("pv-scroll pv-scroll-live" if in_builder else "pv-scroll"):
            ...
            with ui.element("main").classes("pv-main"):
                ...
                with ui.element("section").classes("pv-section pv-section-260218").props('id="pv-services"'):
                    ...
                    with ui.element("div").classes("pv-panel pv-panel-glass"):
                        if svc_image_url:
                            _svc_dims = (_builder_preview_dims("services") if in_builder else ((1080, 608) if mode == "pc" else (860, 484)))
                            ui.image(pv_img_src(svc_image_url, max_w=_svc_dims[0], max_h=_svc_dims[1], fit_mode="contain")).classes("pv-services-img q-mb-sm")
...
PACK_SECTION_NOTES = {
    "まずここだけ入力すれば公開できます": "黄色のセルだけ入力すれば大丈夫です。迷った欄は空でもOKです。上から順に進めてください。",
    "文章を入れるところ": "改行できる欄は『改行』列に出ます。改行したい時は Alt+Enter を押してください。現在文字数と最大目安を見ながら、短く伝わる文章にすると見やすいです。",
    "画像はここを見れば迷いません（入力不要）": "画像は Excel に貼らず、ZIP の中の『画像』フォルダへ入れるだけです。推奨サイズやアイコンの作り方は『迷ったときガイド』シートにも書いてあります。",
    "会社概要（こだわりたい人だけ）": "ここは全ての枠を表示しています。空欄の項目は完成HPに出ないので、必要な項目だけ埋めればOKです。",
}

PACK_FIELD_GUIDE = {
    "project_name": {"what": "案件を見分けるための名前です。会社名と同じでもOKです。", "max_chars": 60},
    "company_name": {"what": "会社の正式名称や普段使っている名称を書いてください。", "max_chars": 80},
    "industry": {"what": "いちばん近い業種を選んでください。迷ったら『会社サイト（企業）』でOKです。"},
    "welfare_domain": {"what": "福祉の種類を選んでください。福祉以外なら空のままでOKです。"},
    "welfare_mode": {"what": "通所か入所かを選んでください。福祉以外なら空のままでOKです。"},
    ...
    "catch_copy": {"what": "トップで最初に大きく見える言葉です。『誰に・何を・どんな強みで』を短く書いてください。", "max_chars": 38},
    "hero_sub_catch": {"what": "キャッチコピーの補足です。安心感や対応内容を1文で足してください。", "max_chars": 70},
    "phone": {"what": "公開してよい電話番号を書いてください。", "max_chars": 30},
    "email": {"what": "公開してよいメールアドレスを書いてください。", "max_chars": 120},
    "address": {"what": "公開してよい住所を書いてください。建物名まで入れても大丈夫です。", "max_chars": 120},
    "contact_hours": {"what": "電話やお問い合わせを受け付ける時間を書いてください。", "max_chars": 60},
    "contact_form_mode": {"what": "お問い合わせ方法を選んでください。迷ったら『フォーム方式（おすすめ）』でOKです。"},
    "external_form_url": {"what": "外部フォームを使う時だけ、そのURLを書いてください。", "max_chars": 250},
    "philosophy_title": {"what": "『私たちの想い』の見出しです。短い言葉でOKです。", "max_chars": 28},
    "philosophy_body": {"what": "会社の想い・大切にしていること・お客様への約束を書いてください。2〜4文くらいがおすすめです。", "max_chars": 220, "multiline": True},
    "point_1": {"what": "強みを短く1つ書いてください。", "max_chars": 18},
    "point_2": {"what": "強みを短く1つ書いてください。", "max_chars": 18},
    "point_3": {"what": "強みを短く1つ書いてください。", "max_chars": 18},
    "services_title": {"what": "業務内容のまとまり見出しです。", "max_chars": 28},
    "services_lead": {"what": "サービス全体の説明を1〜2文で書いてください。", "max_chars": 120, "multiline": True},
    "service_1_title": {"what": "サービス名を書いてください。", "max_chars": 24},
    "service_1_body": {"what": "サービス内容を短くわかりやすく書いてください。", "max_chars": 90, "multiline": True},
    "service_2_title": {"what": "サービス名を書いてください。", "max_chars": 24},
    "service_2_body": {"what": "サービス内容を短くわかりやすく書いてください。", "max_chars": 90, "multiline": True},
    "service_3_title": {"what": "サービス名を書いてください。", "max_chars": 24},
    "service_3_body": {"what": "サービス内容を短くわかりやすく書いてください。", "max_chars": 90, "multiline": True},
    "faq_q_1": {"what": "お客様がよく聞く質問を書いてください。", "max_chars": 60},
    "faq_a_1": {"what": "質問への答えを簡単に書いてください。", "max_chars": 120, "multiline": True},
    "faq_q_2": {"what": "お客様がよく聞く質問を書いてください。", "max_chars": 60},
    "faq_a_2": {"what": "質問への答えを簡単に書いてください。", "max_chars": 120, "multiline": True},
    "news_date_1": {"what": "公開したい日付を YYYY-MM-DD 形式で書いてください。", "max_chars": 10},
    "news_category_1": {"what": "『お知らせ』『更新情報』などを書いてください。", "max_chars": 20},
    "news_title_1": {"what": "お知らせの見出しを書いてください。", "max_chars": 50},
    "news_body_1": {"what": "お知らせ本文です。長くしすぎず、要点だけで大丈夫です。", "max_chars": 160, "multiline": True},
    "map_url": {"what": "Googleマップなどの地図URLを書いてください。わからなければ空でもOKです。", "max_chars": 250},
    "access_notes": {"what": "駅からの距離、駐車場の有無など、来社時の補足を書いてください。", "max_chars": 100, "multiline": True},
    "contact_message": {"what": "お問い合わせ欄のひとことです。安心して連絡できる言葉がおすすめです。", "max_chars": 80, "multiline": True},
    "company_profile_mode": {"what": "会社概要を表示するか選んでください。迷ったら『使用しない』でもOKです。"},
    "company_profile_kind": {"what": "見出しの種類です。迷ったら『会社概要』でOKです。"},
    "profile_trade_name": {"what": "会社概要に出す会社名です。", "max_chars": 80},
    "profile_address": {"what": "会社概要に出す所在地です。", "max_chars": 120, "multiline": True},
    "profile_executives": {"what": "代表者名や役員名を書いてください。", "max_chars": 120, "multiline": True},
    "profile_established": {"what": "設立年月日を書いてください。", "max_chars": 40},
    "profile_business": {"what": "会社概要に出す事業内容です。複数ある時は『/』で区切ると見やすいです。", "max_chars": 180, "multiline": True},
    "profile_site_url": {"what": "会社概要に出すサイトURLです。", "max_chars": 250},
    "profile_capital": {"what": "資本金を書いてください。例: 500万円", "max_chars": 40},
    "profile_employees": {"what": "従業員数を書いてください。例: 12名", "max_chars": 30},
}

PACK_IMAGE_GUIDE = {
    "会社ロゴ": {
        "where": "ヘッダーやフッターに表示されます。",
        "recommended": "横長 / PNG推奨 / 1000×300px前後",
        "note": "背景透明のPNGだときれいです。文字だけ・マークだけでもOKです。",
    },
    "サイトアイコン": {
        "where": "ブラウザのタブに出る小さなマークです。",
        "recommended": "正方形 / 256×256px以上 / PNG推奨",
        "note": "背景透明のPNGがおすすめです。最初はロゴのマーク部分だけで作ると失敗しにくいです。",
    },
    "メイン画像1": {
        "where": "トップの大きな画像です。",
        "recommended": "横長 / 1600×900px以上",
        "note": "1枚だけでもOKです。1枚だけ入れた時は他のメイン画像にも自動反映されます。",
    },
    "メイン画像2": {
        "where": "トップの画像切り替えで使います。",
        "recommended": "横長 / 1600×900px以上",
        "note": "無ければ空でも大丈夫です。",
    },
    "メイン画像3": {
    ...
    "想い画像": {
        "where": "『私たちの想い』の横に表示されます。",
        "recommended": "横長 / 1400×900px前後",
        "note": "社内風景・スタッフ・建物・活動写真などがおすすめです。",
    },
    "業務内容画像": {
        "where": "『業務内容』の横に表示されます。",
        "recommended": "横長 / 1400×900px前後",
        "note": "サービス内容が伝わる写真がおすすめです。",
    },
}
...
PACK_HELP_SHEET_SECTIONS = [
    {
        "title": "まず最初にやること",
        "lines": [
            "1. 『入力はここだけ』シートで、黄色のセルだけ入力します。",
            "2. わからない欄は空でも大丈夫です。まずは必須だけでOKです。",
            "3. 画像は Excel に貼らず、ZIP 内の『画像』フォルダに入れます。",
            "4. 入力が終わったら、フォルダごと ZIP にして案件一覧から読み込みます。",
        ],
    },
    {
        "title": "文字数と改行の見方",
        "lines": [
            "『現在文字数』は今入っている文字数です。",
            "『最大目安』は読みやすく見せやすい長さの目安です。少し超えても読めますが、短い方が見やすいです。",
            "『改行』が『できます（Alt+Enter）』の欄は、Alt+Enter で改行できます。",
        ],
    },
    {
        "title": "会社概要について",
        "lines": [
            "会社概要は入力欄を全部表示しています。",
            "空欄の項目は完成HPに出ないので、必要なところだけ埋めればOKです。",
        ],
    },
    {
        "title": "画像サイズの調べ方",
        "lines": [
            "Windows では、画像ファイルを右クリック → 『プロパティ』 → 『詳細』で縦横サイズを確認できます。",
            "数字は『px（ピクセル）』で表示されます。",
        ],
    },
    {
        "title": "画像サイズをかんたんに調整する方法",
        "lines": [
            "使い慣れた画像ソフトで、横長画像は幅1600px前後にすると使いやすいです。",
            "難しい時はそのまま入れても大丈夫です。本体側でも縮小調整します。",
            "ただし小さすぎる画像はぼやけやすいので、できれば横1000px以上の画像がおすすめです。",
        ],
    },
    {
        "title": "アイコンの作り方",
        "lines": [
            "サイトアイコンは、ロゴの中の『マーク部分だけ』を正方形で使うと見やすいです。",
            "正方形の画像を用意して、ファイル名を『サイトアイコン.png』にしてください。",
            "背景は透明のPNGだときれいです。難しい時は白背景でも動きますが、見た目は透明PNGの方がきれいです。",
        ],
    },
]
...
2. 『入力はここだけ』シートで黄色セルだけ入力する
3. 文字数列と最大目安を見ながら、短くわかりやすく書く
4. 改行OKの欄は Alt+Enter で改行する
...
def _pack_write_workbook_bytes(seed: dict) -> bytes:
    ...
    ws["B3"] = "黄色のセルだけ入力すればOKです。まずは必須だけで大丈夫です。\n文字数は『現在文字数』で確認できます。『改行』列に『できます（Alt+Enter）』と出る欄は改行できます。\n会社概要は全部の枠を表示していますが、空欄は完成HPに出ません。画像は Excel に貼らず、ZIP の中の『画像』フォルダへ入れてください。"
    ...
    for field in PACK_FIELD_DEFS:
        ...
        if field_type == "image_hint":
            ...
            helper_lines = []
            if what:
                helper_lines.append(f"何を書く？ {what}")
            if example:
                helper_lines.append(f"例: {example}")
            if is_multiline:
