        ...
        with ui.element("header").classes("pv-topbar pv-topbar-260218"):
            with ui.row().classes("pv-topbar-inner items-center justify-between"):
                ...
                with ui.row().classes("items-center no-wrap pv-brand").on("click", lambda e: scroll_to("top")):
                    _favicon_w, _favicon_h = ((64, 64) if in_builder else (72, 72))
                    _logo_w, _logo_h = ((300, 96) if in_builder else (360, 120))
                    if favicon_url:
        ...
        with ui.element("div").classes("pv-scroll pv-scroll-live" if in_builder else "pv-scroll"):
                        ...
                        with ui.element("div").classes("pv-hero-track"):
                            for url in hero_urls:
                                with ui.element("div").classes("pv-hero-slide"):
                                    _hero_dims = ((768, 432) if mode == "pc" else (540, 304)) if in_builder else ((1024, 576) if mode == "pc" else (720, 405))
            ...
            with ui.element("main").classes("pv-main"):
                ...
                with ui.element("section").classes("pv-section pv-section-260218").props('id="pv-about"'):
                    ...
                    with ui.element("div").classes("pv-panel pv-panel-glass"):
                        if about_image_url:
                            _about_dims = ((840, 473) if mode == "pc" else (540, 304)) if in_builder else ((1100, 619) if mode == "pc" else (720, 405))
                ...
                with ui.element("section").classes("pv-section pv-section-260218").props('id="pv-services"'):
                    ...
                    with ui.element("div").classes("pv-panel pv-panel-glass"):
                        if svc_image_url:
                            _svc_dims = ((840, 473) if mode == "pc" else (540, 304)) if in_builder else ((1100, 619) if mode == "pc" else (720, 405))
